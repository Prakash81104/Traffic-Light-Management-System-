...
main = tkinter.Tk()
main.title("Traffic Light Controller System and Road Congestion Detection based on Counting of Vehicles")
...
font = ('times', 16, 'bold')
title = Label(main, text='Traffic Light Controller System and Road Congestion Detection based on Counting of Vehicles',anchor=W, justify=CENTER)
